...
var Wallet_Definitions = /** @class */ (function () {
    function Wallet_Definitions() {
        this.ID = 0;
        this.Serial = 0;
        this.Type = '';
        this.Remars = '';
...
var Wallet_HedDef = /** @class */ (function () {
    function Wallet_HedDef() {
        this.CUSTOM1 = '';
        this.CUSTOM2 = '';
        this.CUSTOM3 = '';
        this.CUSTOM4 = '';
    ...
    return Wallet_HedDef;
}());
var Wallet_Data = /** @class */ (function () {
...
var Settings_Users = /** @class */ (function () {
...
var All_Definitions = /** @class */ (function () {
    function All_Definitions() {
        this.Wallet_HedDef = '';

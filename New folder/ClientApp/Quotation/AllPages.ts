       ...
       <div id="Shahadat_Tab" class="tab-content display_none ">
                        ...
                        <div class="col-xs-6 col-lg-6 col-sm-6 ">
                            <select id="TypePeriod" class="form-control ">
                                ...
                                <option class="3" value="Debt">3 Month</option>
                       ...
                       <div class="col-xs-2 col-lg-2 col-sm-2 ">
                        ...
                        <div id="" class="col-xs-6 col-lg-6 col-sm-6 ">
                            <input id="txtAllAmountDue" type="number" disabled inputmode="numeric" name="AmountSH" placeholder="AllAmountDue" class="form-control " />
                        </div>

                        <div id="" class="col-xs-6 col-lg-6 col-sm-6 ">
                            <input id="txtAmountDuePay" type="number" disabled inputmode="numeric" name="AmountSH" placeholder="AmountDuePay" class="form-control " />
                        </div>

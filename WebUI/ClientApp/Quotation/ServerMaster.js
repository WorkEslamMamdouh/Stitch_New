$(document).ready(function () {
    ...
    function SetPageServer() {
        Html_DataServer_Page = "\n\n      \n\n<style>\n\n    .des {\n        width: 22% !important;\n    }\n\n    .uom {\n        width: 11% !important;\n    }\n\n    .Zero {\n        width: 0% !important;\n    }\n\n    .Price {\n        width: 9% !important;\n    }\n\n    .odd {\n        background-color: lightcoral;\n        font-weight: bold;\n        font-size: 16px;\n        color: black;\n    }\n    .even {\n        background-color: #fff2ce;\n        font-weight: bold;\n        font-size: 16px;\n        color: black;\n    }\n    tr {\n        background-color: #b9b9b9;\n        color: black;\n    }\n\n    .px-5 {\n        padding-left: 3rem !important;\n        padding-right: 3rem !important;\n    }\n\n.dropdown {\n  max-width: 13em;\n  margin: 80px auto 0;\n  position: relative;\n  width: 100%;\n}\n\n.dropdown-btn {\n  background: #1d1f24;\n  font-size: 18px;\n  width: 100%;\n  border: none;\n  color: #fff;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 0.7em 0.5em;\n  border-radius: 0.5em;\n  cursor: pointer;\n}\n\n.arrow {\n  border-left: 5px solid transparent;\n  border-right: 5px solid transparent;\n  border-top: 6px solid #fff;\n  transition: transform ease-in-out 0.3s;\n}\n\n.dropdown-content {\n  border-radius: 0.5em !important;\n    height: 20px;\n    position: absolute;\n    z-index: 99999;\nwidth: 300px; height: 100px; overflow: auto;\n}\n\n.dropdown-content li {\n  background: #000000bf;\n\n  position: relative; \n  transition: 0.5s;\n  transition-delay: calc(60ms * var(--delay));\n    color: wheat;\nfont-weight: bold;\n}\n\n.dropdown-btn:focus + .dropdown-content li {\n  left: 0;\n}\n\n.dropdown-btn:focus + .dropdown-content {\n  visibility: visible;\n}\n\n.dropdown-btn:focus > .arrow {\n  transform: rotate(180deg);\n}\n\n.dropdown-content li:hover {\n  background: #1d1f24;\n}\n\n.dropdown-content li a {\n  display: block; \n  color: #fff; \n  text-decoration: none;\n}\n \n\n</style>\n<body class=\"materialdesign\">\n    <div id=\"Body_animated".concat(CountPage, "\"  class=\"content-inner-all animate__animated animate__bounceInLeft\">\n        <div class=\"sparkline8-graph col-xs-12\" style=\"border-radius: 50px;\">\n\n         \n            <div class=\"col-xs-12 col-lg-1 col-sm-12\">\n                <label>Database</label>\n            </div>\n            <div class=\"col-xs-12 col-lg-3 col-sm-12\">\n                <select id=\"Database").concat(CountPage, "\" class=\"form-control \"></select>\n            </div>\n\n\n               <div class=\"col-xs-12 col-lg-1 col-sm-12\">\n                <label>Tables</label>\n            </div>\n            <div class=\"col-xs-12 col-lg-3 col-sm-12\">\n                <select id=\"DataSours").concat(CountPage, "\" class=\"form-control \"></select>\n            </div>\n\n            \n           <div class=\"col-xs-12 col-lg-1 col-sm-12\">\n                <label>Columns</label>\n            </div>\n            <div class=\"col-xs-12 col-lg-3 col-sm-12\">\n                <select id=\"Columns_Table").concat(CountPage, "\" class=\"form-control \"></select>\n            </div>\n\n            <div class=\"col-xs-12\">\n                <br />\n            </div>\n            <div class=\"col-xs-12 col-lg-1 col-sm-12\">\n                <label>Order</label>\n            </div>\n            <div class=\"col-xs-12 col-lg-3 col-sm-12\">\n                <select id=\"ORDER_Table").concat(CountPage, "\" class=\"form-control \">\n                    <option value=\"DESC\">DESC</option>\n                    <option value=\"ASC\">ASC</option>\n                </select>\n            </div>\n\n            <div class=\"col-xs-12 col-lg-1 col-sm-12\">\n                <label>Top</label>\n            </div>\n            <div class=\"col-xs-12 col-lg-3 col-sm-12\">\n                <select id=\"top").concat(CountPage, "\" class=\"form-control \">\n                    <option value=\"100\">100</option>\n                    <option value=\"200\">200</option>\n                    <option value=\"300\">300</option>\n                    <option value=\"400\">400</option>\n                    <option value=\"500\">500</option>\n                    <option value=\"1000\">1000</option>\n                    <option value=\"1500\">1500</option>\n                    <option value=\"2000\">2000</option>\n                    <option value=\"2500\">2500</option>\n                    <option value=\"3000\">3000</option>\n                    <option value=\"4000\">4000</option>\n                    <option value=\"5000\">5000</option>\n                </select>\n            </div>\n\n            <div class=\"col-xs-12\">\n                <br />\n            </div>\n\n           \n\n            <div class=\"col-xs-12 col-lg-1 col-sm-12\">\n                <label>New Query</label>\n            </div>\n            <div class=\"col-xs-12 col-lg-11 col-sm-12\">\n                <button id=\"SelectText").concat(CountPage, "\"  class=\"form-control display_none\" value=\"\"  ></button>\n                <textarea id=\"New_Query").concat(CountPage, "\" type=\"text\" class=\"form-control \" value=\"\" style=\"height: 150px;\"></textarea>\n                <ul class=\"dropdown-content\" role=\"menu\" id=\"autocompleteList").concat(CountPage, "\"></ul>\n            </div>\n\n         \n\n                        <div class=\"col-xs-12\">\n                            <br />\n                        </div>\n             <div class=\"col-xs-12\">\n                            <br />\n                        </div>\n             <div class=\"col-xs-12\">\n                            <br />\n                        </div>\n             <div class=\"col-xs-12\">\n                            <br />\n                        </div>\n             <div class=\"col-xs-12\">\n                            <br />\n                        </div> \n            <div class=\"col-xs-12 col-lg-12 col-sm-12\">\n                <button id=\"GenerateModels").concat(CountPage, "\" value=\"Generate Models\" class=\"col-xs-12 col-lg-12 col-sm-12 btn btn-custon-four btn-danger\">    Execute </button>\n                <button id=\"RefreshDisplay").concat(CountPage, "\" value=\"Generate Models\" class=\"display_none  col-xs-12 col-lg-12 col-sm-12 btn btn-custon-four btn-danger\">    RefreshDisplay </button>\n            </div>\n\n\n\n\n        </div>\n\n\n\n\n        <div class=\"sparkline8-graph col-xs-12\" style=\"border-radius: 50px;\">\n\n            <div class=\"inside-table my-4\">\n                <h2 id=\"searchTitle").concat(CountPage, "\"></h2>\n                <div id=\"tableDiv").concat(CountPage, "\">\n\n                </div>\n            </div>\n\n        </div>\n\n        <div id=\"Grad1").concat(CountPage, "\" class=\"sparkline8-graph col-xs-12\" style=\"border-radius: 50px;\">\n\n        </div>\n\n\n\n\n    </div>\n     \n\n</body>\n");
    }
    ...
    function BuildControls(cnt) {
        debugger;
        var label_Html = "";
        label_Html = "\n            <li class=\"nav-item\"  data_Cnt_Page=\"".concat(cnt, "\" Data_Remark=\"tab_").concat(cnt, "_Server\">\n                <a id=\"a_Tab_").concat(cnt, "\" class=\"nav-link active\" data-toggle=\"tab\" href=\"#Tab_").concat(cnt, "\">Server ( ").concat(cnt + 1, " )</a>\n            </li>");
        $("#label_Tab").append(label_Html);
        var Area_Html = "";
        Area_Html = "\n            <div class=\"tab-pane   active\" id=\"Tab_".concat(cnt, "\">\n                <div class=\"card\">\n                    <input id=\"ID").concat(cnt, "\" type=\"hidden\" value=\"0\" />\n                    <iframe class=\"tearea display_none\" id=\"tab_").concat(cnt, "_Server\" frameBorder=\"0\"scrolling=\"auto\" width=\"100%\" height=\"650\"></iframe> \n                </div>\n            </div>");
    ...
    function Add_Div_Conact(cnt) {
        var Div_Conact = "\n        <style>\n                    \n                datalist {\n                  position: absolute;\n                  max-height: 20em;\n                  border: 0 none;\n                  overflow-x: hidden;\n                  overflow-y: auto;\n                      background-color: black;\n    color: wheat;\n                }\n\n                datalist option {\n                  font-size: 0.8em;\n                  padding: 0.3em 1em;\n                  background-color: #ccc;\n                  cursor: pointer;\n                      background-color: black;\n    color: wheat;\n                }\n\n                datalist option:hover, datalist option:focus {\n                  color: #fff;\n                  background-color: #036;\n                  outline: 0 none;\n                      background-color: black;\n    color: wheat;\n                }\n        </style>\n           <div id=\"Div_Conact".concat(cnt, "\" class=\"AllButConact\">\n           <div class=\"col-xs-12 col-lg-1 col-sm-12 \">\n                <label class=\"_LabelColor\">Server</label>\n            </div>\n            <div class=\"col-xs-12 col-lg-3 col-sm-12 \">\n\n                <input id=\"Server").concat(cnt, "\" type=\"text\"  size=\"50\" autocomplete=\"off\" class=\"form-control _LabelColor\" value=\"108.181.197.82\" name=\"Server\" list=\"ServerName").concat(cnt, "\">\n                <datalist id=\"ServerName").concat(cnt, "\">\n\n                    <option value=\"108.181.197.82\">\n                    <option value=\"192.168.1.50\\SQL2014\">\n                </datalist>\n            </div>\n\n            <div class=\"col-xs-12 col-lg-1 col-sm-12\">\n                <label class=\"_LabelColor\">User </label>\n            </div>\n            <div class=\"col-xs-12 col-lg-3 col-sm-12\">\n                <input id=\"User").concat(cnt, "\" type=\"text\"  size=\"50\" autocomplete=\"off\" class=\"form-control _LabelColor\" value=\"SYSUSER\" name=\"Server\" list=\"UserName").concat(cnt, "\">\n                <datalist id=\"UserName").concat(cnt, "\">\n\n                    <option value=\"SYSUSER\">\n                </datalist>\n            </div>\n\n            <div class=\"col-xs-12 col-lg-1 col-sm-12\">\n                <label class=\"_LabelColor\">Password</label>\n            </div>\n            <div class=\"col-xs-12 col-lg-3 col-sm-12 animated animate backInDown\">\n                <input id=\"Password").concat(cnt, "\" type=\"text\"  size=\"50\" autocomplete=\"off\" class=\"form-control _LabelColor\" value=\"SYSUSER2020\" name=\"Password\" list=\"PasswordName").concat(cnt, "\">\n                <datalist id=\"PasswordName").concat(cnt, "\">\n                    <option value=\"SYSUSER2020\">\n                    <option value=\"SYSUSER\">\n                </datalist>\n            </div>\n\n\n\n            <div   class=\"col-xs-12 col-lg-12 col-sm-12\">\n                 <button id=\"Conact").concat(cnt, "\"   class=\" col-xs-12 col-lg-12 col-sm-12 btn btn-custon-four btn-success\">   Conact </button>\n            </div>\n\n         </div>\n\n     \n\n         ");

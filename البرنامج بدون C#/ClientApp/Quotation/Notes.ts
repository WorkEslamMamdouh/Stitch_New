...
$(document).ready(() => {
    ...
    function BuildControls(cnt: number) {
        ...
        $("#a_Tab_" + cnt).on('click', function () {
            $("._active").removeClass("active");
            $("#Tab_" + cnt).addClass("active");
        });

        var Area_Html = "";
        Area_Html = `
            <div class="tab-pane   _active" id="Tab_${cnt}">
                <div class="card">
    ...
    function AddButtonApp_Tap() {
        ...
        $("#label_Tab").append('<li id="App_Tap" class="">  <span class="" data-toggle="tab" href=""><i class="fa fa-plus-circle Add"></i></span></li>');
